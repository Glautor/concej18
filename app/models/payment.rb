class Payment < ApplicationRecord
  ...
  validates :portions, numericality: { less_than_or_equal_to: 4, greater_than: 0 }
  acts_as_paranoid
  ...
  def pay_pagseguro
    ...
    if Rails.env.development? || Rails.env.test?
      ...
      payment.notification_url = 'https://gtiegej17.herokuapp.com/confirm_payment'
      payment.redirect_url = 'https://gtiegej17.herokuapp.com/'
    end
